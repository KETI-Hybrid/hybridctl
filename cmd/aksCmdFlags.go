...
func aksFlags() {
	// aksCmd.Flags().StringP("resource-group", "g", "", "Name of resource group.")
	// aksCmd.Flags().StringP("name", "n", "", "Name of the managed cluster.")

	//addon
	// AddonCmd.Flags().StringP("addon", "a", "", "Specify the Kubernetes addon")
	...
	AKSPodIdentityCmd.Flags().String("cluster-name", "", "The cluster name.")
	AKSPodIdentityCmd.Flags().String("namespace", "", "The pod identity namespace.")
	AKSPodIdentityCmd.Flags().StringP("name", "", "n", "The pod identity name. Generate if not specified.")
	...
	AKSPIAddCmd.Flags().StringP("binding-selector", "", "", "")
	...
	AKSPIDeleteCmd.Flags().StringP("resource-group", "g", "", "The pod identity name. Generate if not specified.")
	AKSPIDeleteCmd.Flags().StringP("cluster-name", "c", "", "The cluster name.")
	AKSPIDeleteCmd.Flags().StringP("namespace", "", "", "The pod identity namespace.")
	AKSPIDeleteCmd.Flags().String("name", "", "Pod id 이름입니다. 지정 하지 않으면 생성 합니다.")
	...
	AKSPIExceptionAddCmd.Flags().StringP("resource-group", "g", "", "The pod identity name. Generate if not specified.")
	...
	AKSPIExceptionAddCmd.Flags().StringP("name", "n", "", "Pod id 이름입니다. 지정 하지 않으면 생성 합니다.")
	...
	AKSPIExceptionDeleteCmd.Flags().StringP("resource-group", "g", "", "The pod identity name. Generate if not specified.")
	AKSPIExceptionDeleteCmd.Flags().StringP("cluster-name", "", "", "The cluster name.")
	AKSPIExceptionDeleteCmd.Flags().StringP("namespace", "", "", "The pod identity namespace.")
	AKSPIExceptionDeleteCmd.Flags().StringP("name", "n", "", "Pod id 이름입니다. 지정 하지 않으면 생성 합니다.")
	...
	AKSPIExceptionListCmd.Flags().StringP("resource-group", "g", "", "The pod identity name. Generate if not specified.")
	...
	AKSPIExceptionUpdateCmd.Flags().StringP("resource-group", "g", "", "The pod identity name. Generate if not specified.")
	...
	AKSPIExceptionUpdateCmd.Flags().StringP("name", "n", "", "Pod id 이름입니다. 지정 하지 않으면 생성 합니다.")
